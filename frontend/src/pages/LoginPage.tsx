...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background overflow-hidden">
      {/* Ambient glow orbs */}
      <div className="glow-orb glow-violet w-[500px] h-[500px] -top-48 -left-48 animate-pulse-glow" />
      <div className="glow-orb glow-blue w-[400px] h-[400px] -bottom-32 -right-32 animate-pulse-glow" style={{ animationDelay: '2s' }} />
      <div className="glow-orb glow-pink w-[300px] h-[300px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse-glow" style={{ animationDelay: '4s' }} />
